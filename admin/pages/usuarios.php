...
<section class="aside-main">
    ...
    <main>
        ...
        <section class="acciones-admin">
            <button class="btn-agregar" id="btn-agregarcat">+ Agregar usuario</button>
        ...
        <section class="contenedor-tabla-prods">
            <table class="tabla-productos">
                ...
                <tbody>
                    <?php
                    $conexion = conectar();
                    $resultado = mysqli_query($conexion, 'SELECT id_usuario, email, usuario, rol  FROM usuarios');
...
<section class="contenedormodal" id="contenedormodal-crearcat">
    <section class="modal">
        <section class="contenedor-formnuevoproducto" id="contenedor-formnuevacat">
            ...
            <form id="formModal" action="../../controlador/nuevo_usuario.php" method="post" enctype="multipart/form-data">
                <section class="form-crear">
                    <input id="idcat" type="hidden" name="idcat">
                    <label for="email">Email</label>
                    <input type="email" name="email" id="email" placeholder="Ingrese aqui..." required maxlength="240">
                    <label for="user">Usuario</label>
                    <input type="text" name="usuario" id="user" placeholder="Ingrese aqui..." required maxlength="240">
                    <label for="password">Contraseña</label>
                    <input type="password" name="pass" id="password" placeholder="Ingrese aqui..." required maxlength="240">
...
echo '<script src="../js/modal-CMusers.js"></script>';
